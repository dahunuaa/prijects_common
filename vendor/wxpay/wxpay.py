...
class WxPayConf_pub(object):
    ...
    APPID = "wx28e24a7ae7937e2c"
    #JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    APPSECRET = "5e6a7326ce508e22bca6d6e7ead0c286 "
    #受理商ID，身份标识
    MCHID = "1309964101"
...
class JsApi_pub(Common_util_pub):
    ...
    def get_user_info(self):
        ...
        url = "https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s&lang=zh_CN"%(res.get("access_token",''),res.get("openid",''))
        data = HttpClient().get(url)
        return json.loads(data)
